...
/**
 * REST controller for managing {@link org.launchcode.therapytracker.domain.Appointment}.
 */
@RestController
@RequestMapping("/api")
public class AppointmentResource {
    ...
    public ResponseEntity<List<AppointmentDTO>> getAllAppointments(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
